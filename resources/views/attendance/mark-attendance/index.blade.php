@extends('layouts.app')
@section('title', 'Manage Attendance List')
@section('pageTitle', 'Manage Attendance List')
@section('breadcumb')
...
@section('content')
    ...
    <div class="mt-4 ">
                ...
                <div class="grid items-end grid-cols-1 gap-4 mt-2 sm:grid-cols-5 lg:gap-6">
                    ...
                    <div id="attendance-type-container">
                        <label for="attendance-checkbox"
                            class="inline-block font-medium text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                            Type
                        </label>
                        <ul class="flex flex-col sm:flex-row">
                            <li
                                class="inline-flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-neutral-100 dark:bg-neutral-700 border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ms-px sm:mt-0 sm:first:rounded-se-none sm:first:rounded-es-lg sm:last:rounded-es-none sm:last:rounded-se-lg dark:border-neutral-700 dark:text-white">
                                <div class="relative flex items-start w-full">
                                    <div class="flex items-center h-5">
                                        <input id="attendance-monthly" value="monthly" name="attendance-type" type="radio"
                                            class="text-red-600 border-gray-300 rounded-full focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-red-500 dark:checked:border-red-500 dark:focus:ring-offset-gray-800"
                                            checked="">
                                    </div>
                                    <label for="attendance-monthly"
                                        class="block w-full text-sm text-gray-600 ms-3 dark:text-neutral-300">
                                        Monthly
                                    </label>
                                </div>
                            </li>
                            <li
                                ...
                                <div class="relative flex items-start w-full">
                                    <div class="flex items-center h-5">
                                        <input id="attendance-daily" value="daily" name="attendance-type" type="radio"
                                            class="text-red-600 border-gray-300 rounded-full focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-red-500 dark:checked:border-red-500 dark:focus:ring-offset-gray-800">
                                    </div>
                                    <label for="attendance-daily"
                                        class="block w-full text-sm text-gray-600 ms-3 dark:text-neutral-300">
                                        Daily
                                    </label>
                                </div>
                    ...
                    <div id="attendance-month-container" style="display: none;">
                        <div>
                            <label for="attendance-month"
                                class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                                Month
                            </label>
                            <input id="attendance-month" name="attendance-month" type="month"
        ...
        <div class="mt-4 ">
            <div
                class="flex flex-col p-2 border rounded-lg dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700">
                            ...
                            <table id="example" class="w-full display hover divide-neutral-200 dark:divide-neutral-700">
                                <thead class="">
                                    <tr class=" dark:hover:bg-neutral-800">
                                        ...
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">STATUS
                                        </th>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">CHECK
                                            IN</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">CHECK
                                            OUT</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">EARLY
                                            LEAVING</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">
                                            OVERTIME</th>
            ...
            <div class="p-4 overflow-y-auto">
                <div class="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-2 lg:gap-6">
                    <div class="max-w-full mt-3">
                        <label for="employee"
                            class="block mb-2 text-sm font-semibold text-gray-800 dark:text-white">Employee</label>
                    ...
                    <div class="max-w-full mt-3">
                        <label for="attendance-date"
                            class="block mb-2 text-sm font-semibold text-gray-800 dark:text-white">Date</label>
                ...
                <div class="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-2 lg:gap-6">
                    <div class="max-w-full mt-3">
                        <label for="attendance-checkin"
                            class="block mb-2 text-sm font-semibold text-gray-800 dark:text-white">Check-in Time</label>
                        <input type="time" id="attendance-checkin"
                            class="block w-full px-4 py-3 text-sm text-gray-800 border border-gray-200 rounded-lg focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 -800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            value="10:00">
                    </div>
                    <div class="max-w-full mt-3">
                        <label for="attendance-checkout"
                            class="block mb-2 text-sm font-semibold text-gray-800 dark:text-white">Check-out Time</label>
                        <input type="time" id="attendance-checkout"
                            class="block w-full px-4 py-3 text-sm text-gray-800 border border-gray-200 rounded-lg focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 -800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            value="18:00">
                    </div>
                </div>
