                        ...
                        <div class="overflow-x-auto">
                            <table id="example"  class="w-full display hover divide-neutral-200 dark:divide-neutral-700">
                                ...
                                <tr class=" dark:hover:bg-neutral-800">
                                    ...
                                    <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">EARLY LEAVING</th>
                                    <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">OVERTIME</th>
                                ...
                                <tr class="cursor-pointer dark:hover:bg-neutral-800">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">Apr 18, 2014</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">Present</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">10:00 AM</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">6:00 AM</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">00:00:00</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">00:00:00</td>
