                    ...
                    <div class="overflow-x-auto">
                        <table id="example"  class="w-full display hover divide-neutral-200 dark:divide-neutral-700">
                            ...
                            <tr class=" dark:hover:bg-neutral-800">
                                ...
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start" >LEAVE TYPE</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start" >APPLIED ON</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">START DATE</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">END DATE</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">TOTAL DAYS</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">LEAVE REASON</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start">STATUS</th>
                            ...
                            <tr class="cursor-pointer dark:hover:bg-neutral-800">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">Annual Leave</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">	Mar 31, 2024</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">	Mar 31, 2024</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">Mar 31, 2024</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">1 Days</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">Fiver</td>
