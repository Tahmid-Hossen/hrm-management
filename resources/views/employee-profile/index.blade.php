        ...
        <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 -800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                     ...
                     alt="Bonnie image" />
                <h5 class="mb-1 text-xl font-medium text-red-600 dark:text-red-600">Bonnie Green</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">Web Designer</span>



                <div class="flex mt-4 md:mt-6">
                    <a href="#"
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 hover:text-white dark:text-white">#EMP0000001</a>
        ...
        <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 -800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                     src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80"
                     alt="Bonnie image" />
                <h5 class="mb-1 text-xl font-medium text-red-600 dark:text-red-600">Green Bonnie</h5>
                ...
                <div class="flex mt-4 md:mt-6">
                    <a href="#"
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 hover:text-white dark:text-white">#EMP0000002</a>
        ...
        <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 -800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                     src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80"
                     alt="Bonnie image" />
                <h5 class="mb-1 text-xl font-medium text-red-600 dark:text-red-600">Bonnie Deo</h5>
                ...
                <div class="flex mt-4 md:mt-6">
                    <a href="#"
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 hover:text-white dark:text-white">#EMP0000003</a>
        ...
        <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 -800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                     src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80"
                     alt="Bonnie image" />
                <h5 class="mb-1 text-xl font-medium text-red-600 dark:text-red-600">John Deo</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">Software Engineer</span>
                ...
                <div class="flex mt-4 md:mt-6">
                    <a href="#"
                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 hover:text-white dark:text-white">#EMP0000004</a>
