            ...
            <div class="flex justify-between items-end gap-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <div>
                        ...
                        <input id="searchKey" onkeyup="handleSearchInput()" name="icon" class="inputField" placeholder="Search users" />
                    </div>

                    <div>
                        <label for="select-filter" class="inputLabel">Company</label>

                        <select id="company" onchange="fetchData()" name="select-filter" class="inputField">
                    ...
                    <div>
                        ...
                        <select id="department" onchange="fetchData()" class="inputField">
                            <option value="">All</option>
                    ...
                    <div>
                        ...
                        <select id="designation" onchange="fetchData()" name="designation" class="inputField">
                            <option value="">All</option>
                ...
                <div class="">
                    <div class="inline-block hs-tooltip">
                        <button type="reset" class="btn-red" onclick="handleSearchInput()">
    ...
    <x-containers.container-box>
        <div class="overflow-x-auto">
            <div class="w-full align-middle">
                <div class="overflow-x-auto">
                    <table id="dataTable" class="w-full display divide-neutral-200 dark:divide-neutral-700">
                        <thead class="">
