...
<ol class="mr-2 mt-2 flex items-center whitespace-nowrap">
    <li class="inline-flex items-center">
        <a class="flex items-center text-sm text-gray-500 hover:text-red-600 focus:text-neutral-600 focus:outline-none dark:hover:text-red-600 dark:hover:text-red-600 dark:hover:text-red-600 dark:focus:text-neutral-600" href="#">
    ...
    <li class="inline-flex items-center truncate text-sm font-semibold text-red-600 dark:text-red-600 dark:hover:text-red-600 dark:hover:text-red-600" aria-current="page">
        Employee Profile
    </li>
</ol>
@endsection
...
<div class="flex flex-wrap justify-end gap-2">
    ...
    <div class="hs-tooltip inline-block">
        <a type="button" href="/" class="inline-flex items-center gap-x-2 rounded-lg border border-neutral-300 px-2 py-2 text-sm font-semibold text-gray-500 hover:border-red-600 hover:text-red-600 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:text-gray-400 dark:hover:border-red-600 dark:hover:text-red-500">
    ...
    <!-- create button -->
    <div class="hs-tooltip inline-block">
        <button type="button" data-hs-overlay="#create-new-employee-modal" class="inline-flex items-center gap-x-2 rounded-lg border border-neutral-300 px-2 py-2 text-sm font-semibold text-gray-500 hover:border-red-600 hover:text-red-600 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:text-gray-400 dark:hover:border-red-600 dark:hover:text-red-500">
...
@section("content")
<div class="mt-4">
    <div class="flex flex-col rounded-lg border border-neutral-200 p-2 dark:border-neutral-700 dark:bg-neutral-800">
        <div class="-m-1.5 overflow-x-auto">
            <div class="w-full p-1.5 align-middle">
                <div class="overflow-x-auto">
                    <table id="example" class="hover w-full divide-neutral-200 dark:divide-neutral-700">
                        <thead class="">
                        ...
                        <tbody class="w-full divide-neutral-200 dark:divide-neutral-700">
                            ...
                            <tr class="cursor-pointer text-start dark:hover:bg-neutral-800">
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-800 dark:text-gray-200">
                                    <a href="{{ route("employees.view", $employee->id) }}" class="dark:hover:text-red-white inline-flex items-center rounded-lg bg-red-600 px-4 py-2 text-center text-sm font-medium text-white hover:bg-red-700 hover:text-white dark:bg-red-600 dark:text-white dark:hover:bg-red-700">
                                        {{ $employee->emp_id }}
                                    </a>
                                </td>
                        ...
                        <tbody class="w-full divide-neutral-200 dark:divide-neutral-700">
                            ...
                            <tr class="cursor-pointer text-start dark:hover:bg-neutral-800">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-end text-sm font-medium">
                                    <div class="flex gap-3">
                                        <div class="inline-block hs-tooltip">
                                            <form action="{{ route('employees.force-delete', $employee->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="inline-flex items-center px-2 py-2 text-sm font-semibold text-gray-500 border rounded-lg hs-tooltip-toggle border-neutral-300 gap-x-2 hover:border-red-600 hover:text-red-600 disabled:opacity-50 disabled:pointer-events-none dark:border-neutral-700 dark:text-gray-400 dark:hover:text-red-500 dark:hover:border-red-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
                                                        <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5zm13-3H1v2h14zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5"/>
                                                    </svg>
                                                    <span class="absolute z-10 invisible inline-block px-2 py-1 text-white transition-opacity bg-red-600 rounded-lg shadow-md opacity-0 hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible" role="tooltip">
