...
<div id="segment-3" class="hidden" role="tabpanel" aria-labelledby="segment-item-3">
    <div class="py-3">
        <div class="flex justify-between">
            ...
            <span id="update-info-button-segment-three" class="cursor-pointer"><i class="fa-solid fa-pen-to-square"></i></span>
        </div>
        <div class="overflow-y-auto">
                            <!-- Card Section -->
                            <div class="mx-auto">
                                            ...
                                            <div class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:gap-6">
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <input id="department_one" name="department_one" type="text" class="block w-full rounded-lg border border-gray-200 bg-neutral-100 px-4 py-3 text-sm focus:border-red-500 focus:ring-red-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="{{ $education->department }}" disabled />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:gap-6">
                                                <div>
                                                    ...
                                                    <input id="passing_year_one" name="passing_year_one" type="date" class="block w-full rounded-lg border border-gray-200 bg-neutral-100 px-4 py-3 text-sm focus:border-red-500 focus:ring-red-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="{{ $education->passing_year }}" disabled />
                                                </div>
                                                <div>
                                                    <div>
                                                        ...
                                                        <input id="result_one" name="result_one" type="text" class="block w-full rounded-lg border border-gray-200 bg-neutral-100 px-4 py-3 text-sm focus:border-red-500 focus:ring-red-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="{{ $education->result }}" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:gap-6">
                                                <div>
                                                    ...
                                                    <input id="passing_year_one" name="passing_year_one" type="text" class="block w-full rounded-lg border border-gray-200 bg-neutral-100 px-4 py-3 text-sm focus:border-red-500 focus:ring-red-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="{{ $education->passing_year }}" disabled />
                                                </div>
                                                <div>
                                                    <div>
                                                        <label for="result_one" class="mt-2.5 inline-block text-sm font-medium text-gray-800 dark:text-neutral-200">
