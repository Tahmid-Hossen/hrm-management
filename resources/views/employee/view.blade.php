...
@section("breadcumb")
    <ol class="mr-2 mt-2 flex items-center whitespace-nowrap">
        <li class="inline-flex items-center">
            <a
                class="flex items-center text-sm text-gray-500 hover:text-red-600 focus:text-neutral-600 focus:outline-none dark:hover:text-red-600 dark:focus:text-neutral-600"
                href="#"
            >
                <svg
            ...
            <svg
                class="mx-2 size-4 flex-shrink-0 overflow-visible text-gray-400 dark:text-neutral-600 dark:hover:text-red-600"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <li
            class="inline-flex items-center truncate text-sm font-semibold text-red-600 dark:text-red-600 dark:hover:text-red-600"
            aria-current="page"
        >
            Employee Details
        </li>
            ...
            <div class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-6">
                ...
                >
                    <div class="flex justify-center">
                        <img
                            class="h-[200px] w-[200px] rounded-full bg-contain bg-center"
                ...
                <div
                    class="grid items-center gap-3 sm:grid-cols-2 sm:gap-6 lg:grid-cols-2"
                >
                    <!-- Card -->
                    <a
                    ...
                    <!-- Card -->
                    <a
                        class="group flex flex-col rounded-xl border bg-white shadow-sm transition hover:shadow-md dark:border-neutral-800 dark:bg-neutral-700"
                        href="#"
                    >
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                ...
                                <div class="ms-5 grow">
                                    <h3
                                        class="font-semibold text-gray-800 group-hover:text-red-600 dark:text-neutral-200 dark:group-hover:text-neutral-400"
                                    >
                                        Joining date
                                    </h3>
                                    <p
            ...
            <div class="flex">
                ...
                >
                    ...
                    >
                        <button
                            type="button"
                            class="active inline-flex items-center gap-x-2 rounded-lg bg-transparent px-4 py-3 text-sm font-medium text-gray-500 hover:hover:text-red-600 hover:text-gray-700 disabled:pointer-events-none disabled:opacity-50 hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:text-neutral-400 dark:hover:text-white dark:hs-tab-active:bg-gray-800 hs-tab-active:dark:bg-neutral-800 hs-tab-active:dark:text-neutral-400"
                            id="segment-item-1"
                        ...
                        <button
                            type="button"
                            class="inline-flex items-center gap-x-2 rounded-lg bg-transparent px-4 py-3 text-sm font-medium text-gray-500 hover:hover:text-red-600 hover:text-gray-700 disabled:pointer-events-none disabled:opacity-50 hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:text-neutral-400 dark:hover:text-white dark:hs-tab-active:bg-gray-800 hs-tab-active:dark:bg-neutral-800 hs-tab-active:dark:text-neutral-400"
                            id="segment-item-2"
                                ...
                                <div class="bg-white dark:bg-neutral-800">
                                    ...
                                    >
                                        ...
                                        <div class="mt-3">
                                            <!-- Education -->
                                            <h3
                                                class="text-sm capitalize text-gray-800 dark:text-white"
                                            >
                                                Education - One
                                            </h3>
                                            <div
                                                class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:gap-6"
                                            >
                                                <div>
                                                    <label
                                                        for="institution_name_one"
                                                        class="mt-2.5 inline-block text-sm font-medium text-gray-800 dark:text-neutral-200"
                                                    >
                                                        Instituation Name
                                                    </label>
