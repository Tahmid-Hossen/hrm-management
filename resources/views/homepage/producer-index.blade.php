...
@section('content')
    ...
    <div class="flex h-screen">
        <div class="px-4 py-2 bg-slate-800 lg:w-1/4">
            ...
            <div class="hidden lg:block">
                <div class="my-2 mb-6">
                    <h1 class="text-2xl font-bold text-white">Producer Dashboard</h1>
                </div>
                <ul>
                    <li class="mb-6">
                        <div class="relative">
                ...
                <div class="grid gap-4 lg:grid-cols-3">
                    <div class="flex items-center px-4 py-6 bg-white rounded-md shadow-md">
                        ...
                        <div class="mx-4">
                            ...
                            <div class="text-gray-500">All Movies</div>
                        </div>
                    </div>
                    <div class="flex items-center px-4 py-6 bg-white rounded-md shadow-md">
                        <div class="p-3 bg-indigo-600 rounded">
                        ...
                        <div class="mx-4">
                            ...
                            <div class="text-gray-500">All Screens</div>
                        </div>
                    </div>
                    <div class="flex items-center px-4 py-6 bg-white rounded-md shadow-md">
                        <div class="p-3 bg-indigo-600 rounded">
                        ...
                        <div class="mx-4">
                            ...
                            <div class="text-gray-500">Running Movies</div>
                        </div>
                    </div>
                </div>
