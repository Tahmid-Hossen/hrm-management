...
<div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-neutral-800 dark:border-neutral-700 dark:hs-overlay-backdrop-open:bg-neutral-900/90">
    ...
    <nav class="flex flex-col flex-wrap w-full p-6 hs-accordion-group" data-hs-accordion-always-open>
        ...
        <ul class="space-y-1.5">
            ...
            <li>
                <a class="{{$isActive=='true' ? $ativeClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-red-600 hover:text-white dark:hover:bg-red-600 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('dashboard')}}">
            ...
            @if(in_array('employee.view', $userPermissions))
            ...
            @php $isActive = request()->is('leaves', 'leaves/*') ? 'true' : 'false'; @endphp
            <li class="hs-accordion {{$isActive=='true' ? 'active' : ''}}" id="payroll-accordion">
                ...
                <div id="payroll-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                    <ul class="flex flex-col gap-1 pt-2 ml-4 ps-2">
                        ...
                        @php $isSubActive = request()->is('leaves/approved') ? 'true' : 'false'; @endphp
                        <li>
                            <a href="{{route('leaves.approved')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-red-600 dark:hover:bg-red-600 hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                                Approved-request
                            </a>
                        </li>

                        @php $isSubActive = request()->is('leaves/rejected') ? 'true' : 'false'; @endphp
                        <li>
                            <a href="{{route('leaves.rejected')}}" class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-red-600 dark:hover:bg-red-600 hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                                Rejected-request
                            </a>
                        </li>
            ...
            <li class="hs-accordion {{$isActive =='true' ? 'active' : ''}}" id="staff-accordion">
                ...
                <div id="staff-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                    <ul class="flex flex-col gap-1 pt-2 ml-4 ps-2">
                        ...
                        <li>
                            <a class="{{$isSubActive=='true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-red-600 dark:hover:bg-red-600 hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none " href="{{route('roles.index')}}">
                                Role
                            </a>
                        </li>
            ...
            @php $isActive = request()->is('timesheet', 'timesheet/*','duty-slots','duty-slots/*','duty-slot-rules','duty-slot-rules/*','manage-leave','manage-leave/*', 'markattendance','markattendance/*','bulkattendance','bulkattendance/*') ? 'true':'false'; @endphp
            <li class="hs-accordion {{$isActive=='true' ? 'active' : ''}}" id="timesheet-accordion">
                ...
                <div id="timesheet-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" {{$isActive =='true' ? 'style=display:block;' : ''}}>
                    <ul class="flex flex-col gap-1 pt-2 ml-4 ps-2">
                        ...
                        @php $isSubActive = request()->is('duty-slot-rules','duty-slot-rules/*') ? 'true' : 'false'; @endphp
                        <li>
                            <a href="{{route('dutySlotRules.index')}}" class="{{ $isSubActive == 'true' ? $ativeSubClass : ''}} flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-black rounded-lg hover:bg-red-600 dark:hover:bg-red-600 hover:text-white dark:text-white dark:hover:text-white dark:focus:outline-none ">
                                Duty Slot Rules
                            </a>
                        </li>
