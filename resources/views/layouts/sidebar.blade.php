<div
    ...
    <nav class="flex flex-col flex-wrap w-full p-6 hs-accordion-group" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            ...
            <li>
                <a
                    class="flex items-center gap-x-3.5 py-2 px-2.5 bg-red-600 text-sm text-white rounded-lg hover:bg-red-600 dark:bg-red-600 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
