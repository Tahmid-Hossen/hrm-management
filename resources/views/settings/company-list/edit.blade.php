    <form class="items-center w-full" action="{{ route('company-list.update', $company->id) }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
            <h3 class="font-bold text-gray-800 dark:text-white">Update Company</h3>
        </div>

        <div>
            <div class="p-4">
                <div class="max-w-full mt-3">
                    <label for="company_name" class="block mb-2 text-sm font-medium text-gray-800 dark:text-white">Company
                        Name</label>
                    <input
