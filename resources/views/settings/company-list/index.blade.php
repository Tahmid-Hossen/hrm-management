...
@section('additionalButton')
    ...
    <div class="flex flex-wrap justify-end gap-2">
        ...
        <div class="inline-block hs-tooltip">
            <button onclick="createCompanyTypeModal()" class="btn-create">
...
@section('content')
                                ...
                                @foreach ($companies as $company)
                                    <tr class="cursor-pointer text-start dark:hover:bg-neutral-800">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">
                                            {{ $company->name }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">
                                            {{ $company->is_active }}</td>
                                        {{-- {{ $department->empDepartment->name ?? '' }} --}}
                                        <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-end">
                                            <div class="flex gap-3">
                                                <div class="inline-block hs-tooltip">
                                                    <button onclick="updateCompanyTypeModal({{ $company->id }})"
                                                        class="btn-edit"><svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="inline-block hs-tooltip">
                                                    <a href="{{ route('company-list.delete', $company->id) }}"
                                                        class="btn-red">
    ...
    {{-- Create Company type Modal --}}
    <div id="create-company-type-modal-form" class="hidden">
        <form action="{{ route('company-list.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Body -->
                ...
                <div class="p-4">
                    ...
                    <div class="max-w-full mt-3">
                        <label for="company_name"
                            class="block mb-2 text-sm font-medium text-gray-800 dark:text-white">Company Name</label>
                        <input
                            ...
                            id="company_name" name="name" type="text" autocomplete="off"
