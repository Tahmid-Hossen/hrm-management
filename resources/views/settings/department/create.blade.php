...
@section("breadcumb")
    <ol class="flex items-center mt-2 mr-2 whitespace-nowrap">
        <li class="inline-flex items-center">
            ...
            >
                <svg
                    class="flex-shrink-0 me-3 size-4"
            ...
            <svg
                class="flex-shrink-0 mx-2 overflow-visible text-gray-400 size-4 dark:text-neutral-600 dark:hover:text-red-600"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                        ...
                        >
                            ...
                            <div class="m-2">
                                ...
                                <div class="max-w-full mt-3">
                                    <label for="department_name" class="block mb-2 text-sm font-medium text-gray-800 dark:text-white">Department Name</label>
