...
@section('additionalButton')
    ...
    <div class="flex flex-wrap justify-end gap-2">
        ...
        <div class="inline-block hs-tooltip">
            <button onclick="createDepartmentTypeModal()" class="btn-create">
...
@section('content')
                                ...
                                @foreach ($departments as $department)
                                    <tr class="cursor-pointer text-start dark:hover:bg-neutral-800">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">
                                            {{ $department->name }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">
                                            {{ $department->is_active }}</td>
                                        {{-- {{ $department->empDepartment->name ?? '' }} --}}
                                        <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-end">
                                            <div class="flex gap-3">
                                                <div class="inline-block hs-tooltip">
                                                    <button onclick="updateDepartmentTypeModal({{ $department->id }})"
                                                        class="btn-edit">
    ...
    <div id="create-department-type-modal-form" class="hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="max-w-full mt-3">
                        <label for="department_name"
                            class="block mb-2 text-sm font-medium text-gray-800 dark:text-white">Department Name</label>
                        <input
                            ...
                            id="department_name" name="name" type="text" autocomplete="off"
