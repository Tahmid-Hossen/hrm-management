            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 w-full align-middle">
                    <div class="overflow-x-auto">
                        <form class="w-full max-w-md" action="{{ route('designation.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="md:flex md:items-center mb-6">
                                ...
                                <div class="md:w-2/3">
                                  <input class="bg-transparent border-2 border-gray-500 rounded w-full py-2 px-4 text-gray-400 leading-tight focus:outline-none focus:bg-transparent focus:border-gray-500" id="department_name" name="name" type="text" autocomplete="off">
                                </div>
                            </div>
                            <div class="md:flex md:items-center mb-6">
                                <div class="md:w-1/3">
                                ...
                                <div class="md:w-2/3">
                                    <select class="select bg-transparent border border-gray-500 w-full max-w-xs" name="is_active">
                                        <option class="bg-transparent" value="1">Yes</option>
                                        <option class="bg-transparent" value="0">No</option>
                                    </select>
                                </div>
                            </div>
