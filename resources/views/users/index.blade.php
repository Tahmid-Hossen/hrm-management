            ...
            <div class="bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 dark:dark:border-neutral-700">
                ...
                <div class="flex flex-col items-center pb-10">
                    ...
                    <div class="flex mt-2 md:mt-3">
                        <a href="#"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-neutral-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"></a>
                        <!-- <a href="#"
